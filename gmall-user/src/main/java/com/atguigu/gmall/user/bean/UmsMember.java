...
public class UmsMember {
    ...
    public void setMember_levelId(String member_levelId) {
    ...
    public int getSourceTtype() {
        return sourceTtype;
    }

    public void setSourceTtype(int sourceTtype) {
        this.sourceTtype = sourceTtype;
    }
